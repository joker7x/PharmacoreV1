        ...
        <div className="fixed inset-0 z-[150] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-md p-0 sm:p-6" dir="rtl">
            ...
            >
                ...
                <div className="px-8 mb-4">
                  <div className="flex bg-slate-100 dark:bg-zinc-900/50 p-1 rounded-[24px] border border-slate-200 dark:border-white/5">
                      <TabItem 
                ...
                <div className="px-8 py-6 overflow-y-auto no-scrollbar flex-1 pb-16">
                    <AnimatePresence mode="wait">
                        {activeTab === 'overview' && (
                            <motion.div key="overview" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-5">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-slate-50 dark:bg-zinc-900/50 p-6 rounded-[32px] border border-slate-100 dark:border-white/5">
                        ...
                        {activeTab === 'market' && (
                            <motion.div key="market" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-4">
                                {tawreedStatus === 'loading' ? (
                                    ...
                                    <div className="text-center py-24 bg-slate-50 dark:bg-zinc-900/50 rounded-[40px] border border-dashed border-slate-200 dark:border-white/10">
                        ...
                        {activeTab === 'ai' && (
                             <motion.div key="ai" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6 py-4">
